...
@Configuration
@ComponentScan
@EntityScan("io.pivotal.microservices.services.user.management.DTOs")
@EnableJpaRepositories("io.pivotal.microservices.services.user.management.Repositories")
...
*/
    ...
    @Value("io.pivotal.microservices.services.user.management.DTOs")
